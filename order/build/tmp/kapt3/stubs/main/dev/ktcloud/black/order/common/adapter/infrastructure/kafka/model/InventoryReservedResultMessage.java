...
public final class InventoryReservedResultMessage {
    ...
    public InventoryReservedResultMessage(long orderId, long inventoryId, int amount, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final dev.ktcloud.black.order.common.adapter.infrastructure.kafka.model.InventoryReservedResultMessage copy(long orderId, long inventoryId, int amount, @org.jetbrains.annotations.NotNull()
    dev.ktcloud.black.order.order.domain.vo.InventoryReserveResultState resultState) {
        return null;
    }
